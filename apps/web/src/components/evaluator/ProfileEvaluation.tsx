...
export function ProfileEvaluation() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Export + Delete placeholder buttons (wired in Tasks 8.2 + 8.3) */}
      <div className="flex flex-wrap items-center gap-3 pt-2">
        <Button
          ...
          aria-disabled="true"
          disabled
          title="Export functionality coming soon (Task 8.2)"
        >
        ...
        <Button
          ...
          aria-disabled="true"
          disabled
          title="Deletion request functionality coming soon (Task 8.3)"
        >
          <Trash2 className="h-4 w-4" />
          Request deletion
        </Button>
        <p className="text-xs text-muted-foreground">
          Export and deletion features are coming soon.
        </p>
      </div>
    </div>
  );
